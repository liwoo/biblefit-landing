...
export function PhoneMockup({ name = "Carl Mabaya" }: PhoneMockupProps) {
  return (
    <div className="relative h-[420px] w-[210px] sm:h-[500px] sm:w-[250px] lg:h-[600px] lg:w-[300px] rounded-[2.5rem] sm:rounded-[3rem] border-6 sm:border-8 border-gray-800 bg-gray-900 shadow-2xl">
      {/* Dynamic Island */}
      ...
      <div className="h-full w-full overflow-hidden rounded-[2rem] sm:rounded-[2.2rem] bg-gradient-to-b from-gray-800 to-gray-900 p-2.5 sm:p-4">
        ...
        <div className="mb-3 sm:mb-4 cursor-pointer rounded-xl sm:rounded-2xl bg-gray-800 p-2.5 sm:p-4 shadow-[0_8px_30px_rgba(0,0,0,0.4)] transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_12px_40px_rgba(0,0,0,0.5)]">
          <h3 className="mb-2 sm:mb-3 text-[10px] sm:text-sm font-semibold text-white">
            BibleFit Activity Rings
          </h3>

          {/* Activity rings */}
          <div className="relative mx-auto mb-3 sm:mb-4 h-28 w-28 sm:h-36 sm:w-36 lg:h-40 lg:w-40">
            {/* Outer ring - Read */}
