...
function FeaturesPage() {
  return (
    <div className="relative flex h-full w-full flex-col overflow-y-auto bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      ...
      {/* Header */}
      <header className="relative z-10 shrink-0 bg-gray-950/50 px-6 py-4">
      ...
      {/* Features Grid */}
      <div className="relative z-10 space-y-24 px-6 pb-16">
        <div className="mx-auto max-w-6xl">
          {/* Feature 1: Simple Bible */}
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
            <div className="flex flex-col justify-center space-y-6">
              <div className="flex h-16 w-16 items-center justify-center rounded-2xl border-2 border-emerald-500/50 bg-emerald-500/20">
                <BookOpen className="h-8 w-8 text-emerald-500" />
              </div>
              <div className="space-y-4">
                <h2 className="text-4xl font-bold text-white">Simple Bible</h2>
                <p className="text-xl text-emerald-400">iOS Native Bible Reading</p>
            ...
            <div className="flex items-center justify-center">
              <div className="h-[400px] w-full rounded-3xl border border-emerald-500/30 bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 backdrop-blur-sm">
                <div className="flex h-full flex-col items-center justify-center space-y-4 text-center">
                  <BookOpen className="h-24 w-24 text-emerald-500" />
                  <p className="text-2xl font-semibold text-white">Beautiful Reading Experience</p>
                  <p className="text-gray-400">Clean, distraction-free interface</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
            <div className="order-2 flex items-center justify-center lg:order-1">
              <div className="h-[400px] w-full rounded-3xl border border-blue-500/30 bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 backdrop-blur-sm">
                <div className="flex h-full flex-col items-center justify-center space-y-4 text-center">
                  <Sparkles className="h-24 w-24 text-blue-500" />
                  <p className="text-2xl font-semibold text-white">Deepen Your Understanding</p>
                  <p className="text-gray-400">Reflect on Scripture meaningfully</p>
                </div>
              </div>
            </div>
            <div className="order-1 flex flex-col justify-center space-y-6 lg:order-2">
              <div className="flex h-16 w-16 items-center justify-center rounded-2xl border-2 border-blue-500/50 bg-blue-500/20">
                <Sparkles className="h-8 w-8 text-blue-500" />
              </div>
              <div className="space-y-4">
                <h2 className="text-4xl font-bold text-white">Guided Meditation</h2>
                <p className="text-xl text-blue-400">Spend time reflecting on the Word</p>
                <p className="text-lg text-gray-300">
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
            <div className="flex flex-col justify-center space-y-6">
              <div className="flex h-16 w-16 items-center justify-center rounded-2xl border-2 border-purple-500/50 bg-purple-500/20">
                <Heart className="h-8 w-8 text-purple-500" />
              </div>
              <div className="space-y-4">
                <h2 className="text-4xl font-bold text-white">Commit to Heart</h2>
                <p className="text-xl text-purple-400">Tools to make the Word stick</p>
                <p className="text-lg text-gray-300">
            ...
            <div className="flex items-center justify-center">
              <div className="h-[400px] w-full rounded-3xl border border-purple-500/30 bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 backdrop-blur-sm">
                <div className="flex h-full flex-col items-center justify-center space-y-4 text-center">
                  <Heart className="h-24 w-24 text-purple-500" />
                  <p className="text-2xl font-semibold text-white">Remember Forever</p>
                  <p className="text-gray-400">Scripture that stays with you</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* CTA Section */}
      <div className="relative z-10 px-6 py-16">
        <div className="mx-auto max-w-3xl rounded-3xl border border-emerald-500/30 bg-gray-900/80 p-12 text-center backdrop-blur-sm">
          ...
          <Button size="lg" className="h-14 rounded-full bg-emerald-500 px-8 text-lg font-semibold text-white hover:bg-emerald-600" asChild>
      ...
      <footer className="relative z-10 shrink-0 bg-gray-950/50 px-6 py-4">
        <div className="mx-auto flex max-w-7xl items-center justify-center">
          <p className="text-sm text-gray-400">© 2024 BibleFit. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
