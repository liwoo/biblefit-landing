...
import { Route as BaseFeaturesImport } from "./app/_base/features"
...
const BaseFeaturesRoute = BaseFeaturesImport.update({
  path: "/features",
  getParentRoute: () => BaseRoute,
} as any)
...
declare module "@tanstack/react-router" {
  interface FileRoutesByPath {
    ...
    "/_base/features": {
      ...
      path: "/features"
      fullPath: "/features"
      preLoaderRoute: typeof BaseFeaturesImport
